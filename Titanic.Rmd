...
```{r}
  ...
  myControl <- trainControl(
    ...
    allowParallel = FALSE,
    preProcOptions = list(rangeBounds=c(0,1)),
...
```{r}
  ...
  legend(0.50, 0.55, legend=c("Decision Tree", "By Gender", "SVM", "Random Forest", "Model Averaged Neural Network", "Multi-layer Perceptron"),
